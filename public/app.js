...
function toggleCollapse(button) { const content = document.getElementById(button.getAttribute("aria-controls")); if (!content) return; const collapsed = button.getAttribute("aria-expanded") === "true"; button.setAttribute("aria-expanded", String(!collapsed)); content.hidden = collapsed; setCollapsed(button.dataset.collapseKey, collapsed); }
